            ...
            <div class="row py-3 border-bottom">
                ...
                <div
                    ...
                    <ul class="d-flex justify-content-end list-unstyled m-0">
                        <li class="">
                            <a href="/store-around-me" class="bg-light p-2 mx-1">
                                Store Around Me
                            </a>
                        </li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                ...
                                {{-- <li>
                                    <a class="dropdown-item" href="#">
                                        <svg width="16" height="16" viewBox="0 0 24 24" class="me-2">
                                            <use xlink:href="#orders-icon"></use>
                                        </svg>
                                        My Orders
                                    </a>
                                </li> --}}
    ...
    <footer class="py-5" style="background: linear-gradient(135deg, #90c74b 0%, #90c74b 100%);" id="footer1">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        <img src="https://agii.ng/frontend/assets/images/Agii1.png" width="105" alt="logo"
                            class="mb-3">
                        <p class="text-white-50 mb-4">Welcome to Agii.ng, Nigeria's premier E-Commerce and technology
                            platform, designed to simplify your connection with trusted service providers and vendors
                            across the nation.</p>
                        <div class="social-links mt-4">
                            <ul class="d-flex list-unstyled gap-2">
                                <li>
                                    <a href="https://www.facebook.com/agiinigeria" target="_blank"
                                        class=" bg-white p-2" title="Facebook">
                                ...
                                <li>
                                    <a href="https://x.com/agiinigeria" target="_blank" class=" bg-white p-2"
                                        title="Twitter">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                ...
                                <li>
                                    <a href="https://youtube.com/@agiinigeria" target="_blank" class=" bg-white p-2"
                                        title="YouTube">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                ...
                                <li>
                                    <a href="https://www.instagram.com/agiinigeria" target="_blank"
                                        class=" bg-white p-2" title="Instagram">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                ...
                                <li>
                                    <a href="https://www.tiktok.com/@agiinigeria" target="_blank"
                                        class=" bg-white p-2" title="TikTok">
                                        t
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="footer-menu">
                        <h5 class="widget-title text-white">Useful Links</h5>
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item">
                                <a href="/about" class="nav-link text-white-50 hover-text-white">About Agii NG</a>
                            </li>
                            <li class="menu-item">
                                <a href="/faq" class="nav-link text-white-50 hover-text-white">FAQ</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://agii.ng/become-affiliate"
                                    class="nav-link text-white-50 hover-text-white">Become an Affiliate</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://agii.ng/become-login"
                                    class="nav-link text-white-50 hover-text-white">Log in Affiliate Account</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item">
                                <a href="/contact" class="nav-link text-white-50 hover-text-white">Contact us</a>
                            </li>
                            <li class="menu-item">
                                <a href="/terms-and-condition" class="nav-link text-white-50 hover-text-white">Terms
                                    and conditions</a>
                            </li>
                            <li class="menu-item">
                                <a href="/policy" class="nav-link text-white-50 hover-text-white">Privacy Policy</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item">
                                <a href="/login" class="nav-link text-white-50 hover-text-white">Sign In</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row mt-5 pt-4 border-top border-white-20">
                <div class="col-md-6">
                    <p class="text-white-50 mb-0">Copyright © 2025 Agii NG. All Rights Reserved.</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <div class="d-flex gap-4 justify-content-md-end justify-content-start">
                        <a href="/terms-and-condition"
                            class="text-white-50 hover-text-white text-decoration-none">Terms of Service</a>
                        <a href="/policy" class="text-white-50 hover-text-white text-decoration-none">Privacy
                            Policy</a>
                    </div>
                </div>
            </div>
