                    ...
                    <div class="form-step active" id="loginStep">
                        ...
                        <form id="loginForm" method="POST" action="{{ route('login.post') }}">
                            ...
                            <div class="row g-2 mb-4 ">
                                <div class="col-12">
                                    <button type="button" class="btn btn-outline-primary w-100 google-auth-btn">
                    ...
                    <div class="form-step" id="registerStep">
                        ...
                        <form id="registerForm" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-step active" id="registerStep1">
                                ...
                                <div class="mt-4">
                                    <button type="button" class="btn btn-primary w-100" id="nextToStep2">Next</button>
                                </div>
                            </div>
                                ...
                                <div id="vendorDetails" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="businessCategory" name="business_category">
                                            ...
                                            <option value="home"
                                                {{ old('business_category') == 'home' ? 'selected' : '' }}>
                                                Home & Garden
                                            </option>
                                            <option value="vehicles"
                                                {{ old('business_category') == 'vehicles' ? 'selected' : '' }}>
                                                Vehicles
                                            </option>
                                            <option value="properties"
                                                {{ old('business_category') == 'properties' ? 'selected' : '' }}>
                                                Properties
                                            </option>
                                            <option value="services"
                                                {{ old('business_category') == 'services' ? 'selected' : '' }}>
                                                Services
                                            </option>
                                        </select>
                                    </div>
            ...
            function initializeFormValidation() {
                ...
                googleAuthBtns.forEach(btn => {
                    btn.addEventListener('click', () => {
                        window.location.href = `/auth/google/redirect/${currentUserType}`;
                    });
                });
