...
@section('content')
    ...
    @foreach ($categories->where('parent_id', null)->take(10) as $mainCategory)
        ...
        @if ($hasProducts)
            <li class="border-bottom category-item position-relative"
                ...
                @if ($subCategories->count() > 0)
                    <div
                        class="subcategories-dropdown bg-white shadow-sm rounded p-3 position-absolute start-100 top-0 d-none"
                        style="min-width: 320px; z-index: 1000;">
                        <div class="row">
                            @foreach ($subCategories as $subCategory)
                                @php
                                    $hasSubProducts = \App\Models\Product::where('category_id', $subCategory->id)
                                        ->where('status', 'active')
                                        ->whereHas('user', fn ($q) => $q->whereHas('activeSubscription'))
                                        ->exists();
                                @endphp
                        ...
                        <div class="welcome-banner bg-success p-4 text-white">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    ...
                                    <p class="lead mb-3">Discover unbeatable deals on thousands of products - from household items and everyday essentials to electronics, fashion, vehicles, and prime properties. Whatever you need, you'll find it all in one convenient place.</p>
                                    <div class="d-flex gap-3">
                                        <a href="/register" class="btn btn-light btn-lg text-success fw-bold">Start Selling</a>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&h=400&q=80" 
                                             class="d-block w-100" alt="Tech Deals" style="height: 400px; object-fit: cover;">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&h=400&q=80" 
                                             class="d-block w-100" alt="Fashion Sale" style="height: 400px; object-fit: cover;">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&h=400&q=80" 
                                             class="d-block w-100" alt="Home Appliances" style="height: 400px; object-fit: cover;">
                                    </div>
                                </div>
    ...
    <section class="boosted-slider-section py-4">
    <div class="container-fluid">
        ...
        <div class="position-relative">
            <div class="boosted-slider swiper">
                        ...
                        <div class="swiper-slide">
                            <div class="service-card bg-white rounded shadow-sm border">
                                ...
                                <div class="service-info p-1">
                                    <h6 class="service-title mb-2">{{ Str::limit($product->title, 35) }}</h6>

                                    <div class="service-rating mb-2 d-flex align-items-center">
                                        <div class="stars">
                                            @for($i = 1; $i <= 5; $i++)
                                                @if($i <= floor($product->rating))
                                                    <i class="bi bi-star-fill text-success small"></i>
                                    ...
                                    <div class="service-meta d-flex justify-content-between align-items-center mb-3">
                                        <div class="location small text-muted">
                                            <i class="bi bi-geo-alt me-1"></i> {{ Str::limit($product->location ?? 'Nigeria', 15) }}
                                        </div>
        ...
        <div class="container-fluid">
            <div class="section-header bg-white rounded shadow-sm p-3 mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('home.category', ['category' => 'hotel']) }}" class="btn btn-outline-success btn-sm">View All Hotels</a>
                </div>
            </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="hotel-card bg-white rounded shadow-sm border">
                            <div class="hotel-image position-relative">
                                ...
                                @endif
                                @if($hotel->discount > 0)
                                <span class="badge bg-danger position-absolute top-0 end-0 m-2">-{{ $hotel->discount }}%</span>
                                @endif
                            </div>
                            <div class="hotel-info p-3">
                                ...
                                <div class="hotel-location mb-2">
                                    <small class="text-muted">
                                        <i class="bi bi-geo-alt me-1"></i> {{ Str::limit($hotel->city, 15) }}, {{ $hotel->state }}
                                    </small>
                                </div>
                                
                                <div class="hotel-price d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="fw-bold text-dark">₦{{ number_format($hotel->price_per_night ?? $hotel->price) }}</span>
                                        <small class="text-muted d-block">per night</small>
                                    </div>
                                    <a href="{{ route('product.show', $hotel->slug) }}" class="btn btn-success btn-sm">
            ...
            <div class="section-header bg-white rounded shadow-sm p-3 mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        @guest
                        <a href="/register" class="btn btn-success btn-sm">Start Selling</a>
                        @endguest
                        ...
                        <div class="store-card bg-white rounded shadow-sm border">
                            <a href="{{ route('stores.show', $store->slug) }}" class="text-decoration-none">
                                ...
                                <div class="store-info p-3 border-top text-center">
                                    <h6 class="store-name mb-2 text-dark">{{ Str::limit($store->store_name, 20) }}</h6>
                                    @if($store->rating > 0)
    ...
    <div class="container-fluid">
        <div class="section-header bg-white rounded shadow-sm p-3 mb-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('services.index') }}" class="btn btn-outline-success btn-sm">View All Services</a>
            </div>
        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-card bg-white rounded shadow-sm border">
                                ...
                                <div class="service-info p-1">
                                    ...
                                    <div class="service-meta d-flex justify-content-between align-items-center mb-3">
                                        <div class="location small text-muted">
                                            <i class="bi bi-geo-alt me-1"></i> {{ Str::limit($service->location, 15) }}
                                        </div>
                                    ...
                                    <a href="{{ route('product.show', $service->slug) }}" class="btn btn-success btn-sm w-100">
    ...
    <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <select class="form-select form-select-sm" name="location">
                ...
                @php
                    $states = \App\Models\Location::select('state')->distinct()->orderBy('state')->get();
                @endphp
        ...
        <div class="d-grid gap-2">
            ...
            @php
                ...
                if (request()->routeIs('home.category')) {
                    $clearUrl = route('home.category', ['category' => request()->route('category')]);
    ...
    <!-- Start Selling CTA -->
    @guest
    <section class="start-selling-cta py-5">
        <div class="container-fluid">
            <div class="bg-success bg-gradient rounded-4 p-4 p-md-5 text-center text-white">
                <h3 class="fw-bold mb-2">Have something to sell?</h3>
                <p class="mb-4">Join thousands of vendors reaching buyers across Nigeria on Agii — it only takes a minute to get started.</p>
                <a href="/register" class="btn btn-light btn-lg text-success fw-bold px-4">Start Selling</a>
            </div>
        </div>
    </section>
    @endguest
...
<style>
    ...
    .services-slider , .boosted-slider  {
        padding: 20px 10px;
    }

    .services-slider .swiper-slide , .boosted-slider .swiper-slide  {
        height: auto;
    }

    .services-slider .swiper-button-next,
    .boosted-slider .swiper-button-next,
    .services-slider .swiper-button-prev , .boosted-slider .swiper-button-prev  {
    ...
    .boosted-slider .swiper-button-next:after,
    .services-slider .swiper-button-prev:after , .boosted-slider .swiper-button-prev:after  {
        font-size: 18px;
        font-weight: bold;
    }

    .services-slider .swiper-button-next:hover,
    .boosted-slider .swiper-button-next:hover,
    .services-slider .swiper-button-prev:hover , .boosted-slider .swiper-button-prev:hover  {
        background: var(--jumia-green);
        color: white;
    }

    .services-slider .swiper-pagination-bullet , .boosted-slider .swiper-pagination-bullet  {
        background: var(--jumia-green);
        opacity: 0.5;
        width: 8px;
        height: 8px;
    ...
    .services-slider .swiper-pagination-bullet-active , .boosted-slider .swiper-pagination-bullet-active  {
        opacity: 1;
        width: 20px;
        border-radius: 4px;
    }
    ...
    @media (max-width: 768px) {
        ...
        .product-title, .hotel-title, .service-title {
            font-size: 13px !important;
            height: 36px;
        }
    ...
    @media (max-width: 576px) {
        ...
        .product-card, .hotel-card, .service-card {
            padding: 0;
        }

        .product-info, .hotel-info, .service-info {
    ...
    .boosted-slider-section .swiper-button-next,
    .services-slider-section .swiper-button-prev , .boosted-slider-section .swiper-button-prev  {
        color: var(--jumia-green);
        background: white;
        width: 40px;
        height: 40px;
    ...
    .boosted-slider-section .swiper-button-next:after,
    .services-slider-section .swiper-button-prev:after , .boosted-slider-section .swiper-button-prev:after  {
        font-size: 18px;
        font-weight: bold;
    }

    .services-slider-section .swiper-button-next:hover,
    .boosted-slider-section .swiper-button-next:hover,
    .services-slider-section .swiper-button-prev:hover , .boosted-slider-section .swiper-button-prev:hover  {
        background: var(--jumia-green);
        color: white;
    }

    /* Position the buttons properly */
    .services-slider-section .swiper-button-next , .boosted-slider-section .swiper-button-next  {
        right: -20px;
    }
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialize Boosted Listings Slider (same behavior as Services Slider)
        const boostedSlider = document.querySelector('.boosted-slider');
        if (boostedSlider) {
            const boostedSwiper = new Swiper('.boosted-slider', {
                slidesPerView: 1,
                spaceBetween: 10,
                navigation: {
                    nextEl: '.boosted-slider-section .swiper-button-next',
                    prevEl: '.boosted-slider-section .swiper-button-prev',
                },
                pagination: {
                    el: '.boosted-slider .swiper-pagination',
                    clickable: true,
                },
                breakpoints: {
                    640: {
