                            ...
                            <div class="dropzone-container">
                                ...
                                <div class="dropzone" onclick="document.getElementById('imageUpload').click()">
                                    <div class="dz-message">
                                        ...
                                        <p class="text-muted">Upload at least 5 photos total, up to 10 (max 5MB each)</p>
                                    </div>
                                </div>
                            </div>
        ...
        function validateStep(step) {
            ...
            switch (step) {
                ...
                case 2:
                    ...
                    break;
                 case 3:
                    const currentImageCount = document.querySelectorAll('#currentImagePreview .preview-item').length;
                    const totalImages = currentImageCount + uploadedImages.length;
                    if (totalImages < 5) {
                        alert(`Please have at least 5 product photos. You currently have ${totalImages}.`);
                        isValid = false;
                    }
                    break;
            }
