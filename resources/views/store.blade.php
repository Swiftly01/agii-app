...
@section('content')
    ...
    <!-- Banner Section -->
    <section class="banner-section py-5 d-none" style="background: linear-gradient(135deg, #90c74b 0%, #74a534 100%);">
        <div class="container">
 ...
 {{-- 
  ...
  <section class="py-5 bg-light">
    ...
    <section class="py-5 bg-white ">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="section-title">Near by Stores</h2>
            ...
            <div class="row g-4">
                @forelse($nearbyStores as $store)
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="store-card card h-100 shadow-sm border-0">
                            @if ($store->banner)
                                <img src="{{ url($store->banner) }}" class="store-banner card-img-top"
                                ...
                                <div class="product-card card h-100 border-0 shadow-sm">
                                    <div class="product-badges">
                                        @if ($product->condition == 'New')
                                            <span class="badge bg-success">New</span>
                                        @elseif($product->negotiable)
                                            <span class="badge bg-warning d-none">Negotiable</span>
                                        @endif
                                    </div>
