...
<head>
    ...
    <style>
        ...
        #pwa-install-banner { align-items: center; gap: 12px; padding: 14px 18px; }
        #pwa-ios-tip { padding: 18px 20px; text-align: center; }
    ...
    {{-- ============================================================
         ...
         MUST be in <head> — before any other scripts load
    ============================================================ --}}
    <script>
...
<body>
    ...
    {{-- ============================================================
         PWA BANNERS — placed right after <body> open so they
    ...
    <div id="pwa-install-banner" role="dialog" aria-label="Install Agii app">
        ...
        <div style="display:flex; flex-direction:column; gap:6px; flex-shrink:0;">
            <button id="pwa-install-btn"
                style="background:#90c74b; color:#fff; border:none; padding:8px 16px;
    ...
    <div id="pwa-ios-tip" role="dialog" aria-label="How to install Agii on iOS">
        ...
        <button id="pwa-ios-dismiss"
            style="margin-top:14px; background:transparent; color:#aaa;
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        <defs>
            <symbol id="link" viewBox="0 0 24 24"><path fill="currentColor" d="M12 19a1 1 0 1 0-1-1a1 1 0 0 0 1 1Zm5 0a1 1 0 1 0-1-1a1 1 0 0 0 1 1Zm0-4a1 1 0 1 0-1-1a1 1 0 0 0 1 1Zm-5 0a1 1 0 1 0-1-1a1 1 0 0 0 1 1Zm7-12h-1V2a1 1 0 0 0-2 0v1H8V2a1 1 0 0 0-2 0v1H5a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3Zm1 17a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-9h16Zm0-11H4V6a1 1 0 0 1 1-1h1v1a1 1 0 0 0 2 0V5h8v1a1 1 0 0 0 2 0V5h1a1 1 0 0 1 1 1ZM7 15a1 1 0 1 0-1-1a1 1 0 0 0 1 1Zm0 4a1 1 0 1 0-1-1a1 1 0 0 0 1 1Z"/></symbol>
            ...
            <symbol id="check" viewBox="0 0 24 24"><path fill="currentColor" d="M18.71 7.21a1 1 0 0 0-1.42 0l-7.45 7.46l-3.13-3.14A1 1 0 1 0 5.29 13l3.84 3.84a1 1 0 0 0 1.42 0l8.16-8.16a1 1 0 0 0 0-1.47Z"/></symbol>
            ...
            <symbol id="close" viewBox="0 0 24 24"><path fill="currentColor" d="M18.71 7.21a1 1 0 0 0-1.42 0L12 12.5L6.71 7.21a1 1 0 0 0-1.42 1.42L10.59 14l-5.3 5.29a1 1 0 0 0 1.42 1.42L12 15.41l5.29 5.3a1 1 0 0 0 1.42-1.42L13.41 14l5.3-5.37a1 1 0 0 0 0-1.42Z"/></symbol>
        </defs>
    </svg>
        ...
        <div class="container-fluid">
            <div class="row py-3 border-bottom">
                ...
                <div class="col-sm-4 col-lg-3 text-center text-sm-start order-1 order-lg-1">
                    <div class="main-logo">
                        <a href="/">
                            <img src="{{ asset('images/agiilogo3.png') }}" width="100" alt="logo" class="img-fluid logo">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-5 order-3 order-lg-2 my-2 my-lg-2">
                    <div class="search-bar row bg-light p-2 my-2 rounded-4 align-items-center">
                        <form id="search-form" class="row w-100 g-2" action="{{ route('products.index') }}" method="GET">
                            ...
                            <div class="col-md-3 d-none d-md-block">
                                @php
                                    $navbarStates = \App\Models\Location::select('state')->distinct()->orderBy('state')->get();
                                @endphp
                                <select name="location" class="form-select border-0 bg-transparent" onchange="this.form.submit()">
                                    <option value="">All States</option>
                                    @foreach($navbarStates as $navbarState)
                                        <option value="{{ $navbarState->state }}" {{ request('location') === $navbarState->state ? 'selected' : '' }}>
                                            {{ $navbarState->state }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end order-2 order-lg-3">
                    <ul class="d-flex justify-content-end list-unstyled m-0">
                        <li>
                            <a href="/store-around-me" class="bg-light p-2 mx-1">Store Around Me</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="#" class="bg-light p-2 mx-1 dropdown-toggle" id="userDropdown"
                    ...
                    <div class="footer-menu">
                        ...
                        <div class="social-links mt-4">
                            <ul class="d-flex list-unstyled gap-2">
                                <li>
                                    <a href="https://www.facebook.com/agiinigeria" target="_blank" class="rounded-full bg-whit p-2" title="Facebook">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M15.12 5.32H17V2.14A26.11 26.11 0 0 0 14.26 2c-2.72 0-4.58 1.66-4.58 4.7v2.62H6.61v3.56h3.07V22h3.68v-9.12h3.06l.46-3.56h-3.52V7.05c0-1.05.28-1.73 1.76-1.73Z"/></svg>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://x.com/agiinigeria" target="_blank" class="rounded-full bg-whit p-2" title="Twitter">
                                ...
                                <li>
                                    <a href="https://youtube.com/@agiinigeria" target="_blank" class="rounded-full bg-whit p-2" title="YouTube">
                                ...
                                <li>
                                    <a href="https://www.instagram.com/agiinigeria" target="_blank" class="rounded-full bg-whit p-2" title="Instagram">
                                ...
                                <li>
                                    <a href="https://www.tiktok.com/@agiinigeria" target="_blank" class="rounded-full bg-whit p-2" title="TikTok">
                                        <svg fill="#fff" viewBox="0 0 32 32" width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M16.656 1.029c1.637-0.025 3.262-0.012 4.886-0.025 0.054 2.031 0.878 3.859 2.189 5.213l-0.002-0.002c1.411 1.271 3.247 2.095 5.271 2.235l0.028 0.002v5.036c-1.912-0.048-3.71-0.489-5.331-1.247l0.082 0.034c-0.784-0.377-1.447-0.764-2.077-1.196l0.052 0.034c-0.012 3.649 0.012 7.298-0.025 10.934-0.103 1.853-0.719 3.543-1.707 4.954l0.020-0.031c-1.652 2.366-4.328 3.919-7.371 4.011l-0.014 0c-0.123 0.006-0.268 0.009-0.414 0.009-1.73 0-3.347-0.482-4.725-1.319l0.040 0.023c-2.508-1.509-4.238-4.091-4.558-7.094l-0.004-0.041c-0.025-0.625-0.037-1.25-0.012-1.862 0.49-4.779 4.494-8.476 9.361-8.476 0.547 0 1.083 0.047 1.604 0.136l-0.056-0.008c0.025 1.849-0.050 3.699-0.050 5.548-0.423-0.153-0.911-0.242-1.42-0.242-1.868 0-3.457 1.194-4.045 2.861l-0.009 0.030c-0.133 0.427-0.21 0.918-0.21 1.426 0 0.206 0.013 0.41 0.037 0.61l-0.002-0.024c0.332 2.046 2.086 3.59 4.201 3.59 0.061 0 0.121-0.001 0.181-0.004l-0.009 0c1.463-0.044 2.733-0.831 3.451-1.994l0.010-0.018c0.267-0.372 0.45-0.822 0.511-1.311l0.001-0.014c0.125-2.237 0.075-4.461 0.087-6.698 0.012-5.036-0.012-10.060 0.025-15.083z"></path></svg>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item"><a href="/about" class="nav-link text-white">About Agii NG</a></li>
                            <li class="menu-item"><a href="/faq" class="nav-link text-white">FAQ</a></li>
                            <li class="menu-item"><a href="https://agii.ng/become-affiliate" class="nav-link text-white">Become an Affiliate</a></li>
                            <li class="menu-item"><a href="https://agii.ng/become-login" class="nav-link text-white">Log in Affiliate Account</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul class="menu-list list-unstyled">
                            ...
                            <li class="menu-item"><a href="/terms-and-condition" class="nav-link text-white">Terms and conditions</a></li>
                            <li class="menu-item"><a href="/policy" class="nav-link text-white">Privacy Policy</a></li>
                        </ul>
                    </div>
                </div>
    ...
    {{-- ============================================================
         ...
         Banner HTML is already in the DOM (top of <body>).
    ============================================================ --}}
    <script>
    (function() {
