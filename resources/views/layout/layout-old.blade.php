        ...
        <div class="container-fluid">
            <div class="row py-3 border-bottom">
                ...
                <div class="col-sm-4 col-lg-3 text-center text-sm-start">
                    <div class="main-logo">
                        <a href="/">
                            <img src="{{ asset('images/agiilogo3.png') }}" alt="logo" class="img-fluid logo">
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="d-flex justify-content-end list-unstyled m-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                ...
                                @else
                                    <li><a class="dropdown-item" href="{{ route('profile.edit') }}">My Profile</a>
                                    </li>
                                    <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        <img src="{{ asset('images/agiilogo3.png') }}" width="105" alt="logo"
                            class="mb-3">
                        <p class="mb-4 text-white">Welcome to Agii.ng, Nigeria's premier E-Commerce and
                            technology
                            platform, designed to simplify your connection with trusted service providers and
                            vendors
                            across the nation.</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul class="menu-list list-unstyled">
                            ...
                            <li class="menu-item"><a href="https://agii.ng/become-affiliate"
                                    class="nav-link text-white">Become an Affiliate</a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        <h5 class="footer-links">Customer Service</h5>
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item"><a href="/contact" class="nav-link text-white">Contact us</a>
                            </li>
                            <li class="menu-item"><a href="/terms-and-condition" class="nav-link text-white">Terms
                                    and conditions</a></li>
                            <li class="menu-item"><a href="/policy" class="nav-link text-white">Privacy
                                    Policy</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        <h5 class="footer-links">My Account</h5>
                        <ul class="menu-list list-unstyled">
            ...
            <div class="row mt-5 pt-4 border-top border-white-20">
                ...
                <div class="col-md-6 text-md-end">
                    <div class="d-flex gap-4 justify-content-md-end justify-content-start">
                        <a href="/terms-and-condition" class="text-white text-decoration-none">Terms of
                            Service</a>
