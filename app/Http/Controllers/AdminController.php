...
class AdminController extends Controller
{
     ...
     */
    // Vendor listing/detail moved to AdminVendorController.
     ...
     * Show all customers
     */
    // Customer listing/detail moved to AdminCustomerController.
...
public function updateProgress(Request $request)
{
    ...
    public function marketerTaskDetail($id)
    {
        ...
        $task->days_remaining_text = $task->days_remaining == 0 ? 'Today' : 
                                    ($task->days_remaining > 0 ? $task->days_remaining . ' days left' : 
...
public function marketerTasks(Request $request)
{
    ...
    $query = Task::where('marketer_id', $user->id)
                ...
                ->select('id', 'title', 'description', 'priority', 'status', 'progress', 
                        'deadline', 'marketer_id', 'assigned_by', 'created_at', 'updated_at',
                        'target_leads', 'target_conversion', 'notes', 'attachment'); // Added 'attachment' here
